  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <ul className="list-disc list-inside mb-4">
        ...
        <li>Usage Data: Information about how you use our application, including your interactions and preferences.</li>
      </ul>
      ...
      <p className="mb-4">
        We take the security of your data seriously and implement appropriate technical and organizational measures to protect your personal information from unauthorized access, use, or disclosure.
      </p>
